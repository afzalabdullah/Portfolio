...
const Contact = ({ contactData }) => {
  ...
  const sendEmail = (e) => {
    ...
    const serviceId = contactData?.emailjsServiceId || "service_pdf9ymo";
    const templateId = contactData?.emailjsTemplateId || "template_vhduyv3";
    const publicKey = contactData?.emailjsPublicKey || "vCwOaTQBBdQFTgP5b";
  ...
  const contactItems = [
    {
      title: "Email",
      data: contactData?.email || "afzalabdullah066@gmail.com",
      link: contactData?.email ? `mailto:${contactData.email}` : "mailto:afzalabdullah066@gmail.com",
    ...
    {
      title: "WhatsApp",
      data: contactData?.whatsapp || "(+92) 311 6702805",
      link: contactData?.whatsappLink || "https://api.whatsapp.com/send/?phone=923116702805&text&type=phone_number&app_absent=0",
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
    },
    {
      title: "LinkedIn",
      data: contactData?.linkedin || "Abdullah Afzal",
      link: contactData?.linkedinLink || "https://www.linkedin.com/in/engr-abdullah-afzal-96b962208/",
